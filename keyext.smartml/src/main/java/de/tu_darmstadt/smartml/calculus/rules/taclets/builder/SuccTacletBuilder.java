...
import de.tu_darmstadt.smartml.calculus.rules.taclets.SMLSuccTaclet;

public class SuccTacletBuilder extends FindTacletBuilder<SMLSuccTaclet> {
    ...
    public SMLSuccTaclet getSuccTaclet() {
        if (find == null) {
        ...
        prefixBuilder.build();
        SMLSuccTaclet t = new SMLSuccTaclet(name,
            (Sequent) find,
    ...
    public SMLSuccTaclet getTaclet() {
