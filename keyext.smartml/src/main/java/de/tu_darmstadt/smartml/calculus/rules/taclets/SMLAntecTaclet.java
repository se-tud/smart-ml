...
import de.tu_darmstadt.smartml.calculus.rules.execution.AntecTacletExecutor;
...
public class SMLAntecTaclet extends SMLFindTaclet {
    ...
    public SMLAntecTaclet(Name name, Sequent find, TacletApplPart applPart,
    ...
    @Override
    public @NonNull SMLAntecTaclet setName(@NonNull String s) {
