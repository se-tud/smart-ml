...
import de.tu_darmstadt.smartml.calculus.rules.taclets.SMLAntecTaclet;
import org.jspecify.annotations.NonNull;

public class AntecTacletBuilder extends FindTacletBuilder<@NonNull SMLAntecTaclet> {
    ...
    public SMLAntecTaclet getTaclet() {
    ...
    public SMLAntecTaclet getAntecTaclet() {
        if (find == null) {
        ...
        SMLAntecTaclet t = new SMLAntecTaclet(name,
            (Sequent) find,
