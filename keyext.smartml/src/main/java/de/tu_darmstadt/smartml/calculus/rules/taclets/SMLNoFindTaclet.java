...
import de.tu_darmstadt.smartml.calculus.rules.execution.NoFindTacletExecutor;
...
public class SMLNoFindTaclet extends SMLTaclet {
    ...
    public SMLNoFindTaclet(Name name, TacletApplPart applPart,
    ...
    @Override
    public @NonNull SMLNoFindTaclet setName(@NonNull String s) {
