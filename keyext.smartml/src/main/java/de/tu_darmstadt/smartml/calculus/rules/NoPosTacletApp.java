...
import de.tu_darmstadt.smartml.strategy.FindTacletAppContainer;
import de.tu_darmstadt.smartml.strategy.NoFindTacletAppContainer;
...
public class NoPosTacletApp extends TacletApp {
    ...
    protected MatchConditions setupMatchConditions(PosInOccurrence pos, Services services) {
        var svInst =
            taclet() instanceof SMLNoFindTaclet
                    ? instantiations()
        ...
        if (taclet() instanceof SMLRewriteTaclet rwTaclet) {
    ...
    public boolean complete() {
        return (uninstantiatedVars().isEmpty() && taclet() instanceof SMLNoFindTaclet
                && ifInstsComplete());
    ...
    public NoPosTacletApp matchFind(PosInOccurrence pos, Services services, Term t) {
        ...
        MatchResultInfo res;
        if (taclet() instanceof SMLFindTaclet) {
    ...
    public TacletApp addInstantiation(
            de.tu_darmstadt.smartml.calculus.rules.matching.inst.SVInstantiations svi,
            Services services) {
