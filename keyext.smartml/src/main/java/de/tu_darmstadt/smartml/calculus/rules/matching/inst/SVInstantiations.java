...
import de.tu_darmstadt.smartml.calculus.rules.sv.SchemaVariableFactory;
...
import static de.tu_darmstadt.smartml.services.Services.convertToLogicElement;
...
public class SVInstantiations
    ...
    public SVInstantiations add(SchemaVariable sv, SModality.SmartMLModalityKind kind,
    ...
    /// @return SVInstantiations the new SVInstantiations containing the given pair
    public SVInstantiations add(SchemaVariable sv, SmartMLProgramElement pe,
    ...
    public Term getTermInstantiation(SchemaVariable sv, LogicServices services) {
        ...
        return switch (inst) {
            case null -> null;
            case Term term -> term;
            case SmartMLProgramElement pe -> convertToLogicElement(pe, (Services) services);
    ...
    /// @param sv the SchemaVariable to be instantiated
    /// @param pe the ProgramElement the SchemaVariable is instantiated with
    public SVInstantiations replace(SchemaVariable sv, SmartMLProgramElement pe,
            Services services) {
    ...
    public SVInstantiations replace(SchemaVariable sv, ImmutableArray<SmartMLProgramElement> pes,
            Services services) {
