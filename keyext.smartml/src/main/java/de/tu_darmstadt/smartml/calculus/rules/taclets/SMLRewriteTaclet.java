...
public class SMLRewriteTaclet extends SMLFindTaclet {
    ...
    public SMLRewriteTaclet(Name name, Term find, TacletApplPart applPart,
    ...
    @Override
    public @NonNull SMLRewriteTaclet setName(@NonNull String s) {
