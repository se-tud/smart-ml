...
public class TermBuilder {
    ...
    public Term prog(SModality.SmartMLModalityKind modKind, SmartMLBlock jb, Term t) {
        return tf.createTerm(SModality.getModality(modKind, jb), new Term[] { t }, null);
    }

    public Term box(SmartMLBlock jb, Term t) {
        return prog(SModality.SmartMLModalityKind.BOX, jb, t);
    }

    public Term dia(SmartMLBlock jb, Term t) {
        return prog(SModality.SmartMLModalityKind.DIA, jb, t);
    }
