...
public final class SchemaType implements SmartType {
    ...
    @Override public String display() {
        ...
        return name + "<" + typeArgs.stream().map(SmartType::display).reduce((a,b)->a + "," + b).orElse("") + ">";
    }

    @Override public boolean equals(Object o){
        if (!(o instanceof SchemaType s)) return false;
        return name.equals(s.name) && typeArgs.equals(s.typeArgs);
    }
    @Override public int hashCode(){ return 31*name.hashCode() + typeArgs.hashCode(); }
}
