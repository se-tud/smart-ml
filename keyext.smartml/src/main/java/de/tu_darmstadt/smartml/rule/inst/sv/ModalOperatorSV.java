...
public class ModalOperatorSV extends SModality.SmartMLModalityKind implements SchemaVariable {
    /// the set of modalities this sv can match
    private final ImmutableSet<SModality.SmartMLModalityKind> modalities;
    ...
    ModalOperatorSV(Name name, ImmutableSet<SModality.SmartMLModalityKind> modalityKinds) {
        super(name);
        this.modalities = modalityKinds;
    }

    /// returns an unmodifiable set of operators this schemavariable can match
    public ImmutableSet<SModality.SmartMLModalityKind> getModalities() {
        return modalities;
    }
